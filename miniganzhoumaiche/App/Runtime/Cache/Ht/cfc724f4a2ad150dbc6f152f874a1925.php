...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
        ...
        <!--  <li>
            <div style="color:#c00; font-size:14px; padding-left:20px;">品牌介绍限39个字，包括符号</div>
         </li>
         <li>
            <div class="d1">品牌介绍:</div>
            <div>
              <textarea class="inp_1" style="width:400px;height:100px;" name="digest" id="digest"/><?php echo ($brand_info["digest"]); ?></textarea>
            </div>
         </li> -->
        <li>
            <div style="color:#c00; font-size:14px; padding-left:20px;"> 上传品牌图片大小 ：200*200</div>
         </li>
         <li data-index="">
            <div class="d1">品牌图片:</div>
            <div>
              <?php if ($brand_info['photo']) { ?>
              <img src="/miniganzhoumaiche/Data/<?php echo $brand_info['photo']; ?>" width="100" height="100" />
              <?php } ?>
