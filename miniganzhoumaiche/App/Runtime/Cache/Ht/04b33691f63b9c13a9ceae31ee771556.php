...
<script type="text/javascript" src="/miniganzhoumaiche/Public/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/ht/js/jCalendar.js"></script>
...
<![endif]-->
<link rel="stylesheet" type="text/css" href="/miniganzhoumaiche/Public/hui/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/miniganzhoumaiche/Public/hui/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="/miniganzhoumaiche/Public/hui/lib/Hui-iconfont/1.0.8/iconfont.css" />

<link rel="stylesheet" type="text/css" href="/miniganzhoumaiche/Public/hui/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/miniganzhoumaiche/Public/hui/static/h-ui.admin/css/style.css" />


<link href="/miniganzhoumaiche/Public/hui/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
  ...
  <form action="?id=<?php echo ($id); ?>&page=<?php echo ($page); ?>&type=<?php echo ($type); ?>&name=<?php echo ($name); ?>&shop_id=<?php echo ($shop_id); ?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text"  name="intro" id="intro" value="<?php echo ($pro_allinfo["intro"]); ?>" style="width:500px;">
         <span style="color:red;font-size: 12px;">默认：含购置税 送一年保险  一年后可买可退</span>
      </div>
    </div>
    <!-- <div class="row cl">
   ...
   <!--  <div class="row cl">
         ...
         <div>缩略图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_x']) { ?>
                  <img src="/miniganzhoumaiche/Data/<?php echo $pro_allinfo2[0]['photo_x']; ?>" width="80" height="80" style="margin-bottom: 3px;" />
                  <br />
              <?php } ?>
         ...
         <div>大图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_d']) { ?>
                  <img src="/miniganzhoumaiche/Data/<?php echo $pro_allinfo2[0]['photo_d']; ?>" width="125" height="125" style="margin-bottom: 3px;" />
                <br />
              <?php } ?>
    ...
    <div class="row cl">
              ...
              <?php foreach ($img_str as $v) { ?>
               <div>
                <div class="img-err" title="删除" onclick="del_img('<?php echo $v; ?>',this);" style="color:red;cursor: pointer;">×</div>
                 ...
                 <?php }else{ ?>
                  <img src="<?php echo '/miniganzhoumaiche/Data/'.$v; ?>" width="125" height="125">
                 <?php } ?>
               </div>
              <?php } ?>
     ...
     <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">首付：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text"  name="price" id="price" value="<?php echo ($pro_allinfo["price"]); ?>" style="width:200px;">
        <span style="color:red;font-size: 12px;">&nbsp;&nbsp;&nbsp;价格单位:  万</span>
      </div>
    </div>

    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">月供：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" class="input-text"  name="gong" id="gong" value="<?php echo ($pro_allinfo["gong"]); ?>" style="width:200px;">
        <span style="color:red;font-size: 12px;">&nbsp;&nbsp;&nbsp;如：1698X12期</span>
      </div>
    </div>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/static/h-ui/js/H-ui.min.js"></script> 
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/miniganzhoumaiche/Public/hui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
  ...
  var uploader = WebUploader.create({
    auto: true,
    swf: '/miniganzhoumaiche/Public/hui/lib/webuploader/0.1.5/Uploader.swf',
  
    // 文件接收服务端。
    server: '/miniganzhoumaiche/Public/hui/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/miniganzhoumaiche/Public/hui/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
...
<script type="text/javascript" src="/miniganzhoumaiche/Public/ht/js/product.js"></script>
<script>
function upadd(obj){
  // alert('aaa');
