...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
            ...
            <div>
               <select class="inp_1" id="position" name="position">
                  ...
                  <option value="1" <?php echo $adv_info['position']==1 ? 'selected="selected"' : NULL; ?>>&nbsp;- 首页轮播</option>
                   <option value="2" <?php echo $adv_info['position']==2 ? 'selected="selected"' : NULL; ?>>&nbsp;- 首页底部</option>
               </select>
            </div>
         </li>
		    <!--  <li>
        ...
        <span style="color:red;font-size: 12px;margin-left:1%;">图片大小：600*300；</span>
         <li data-index="" style="margin-top:10px;">
            ...
            <div>
             <input type="hidden" name="photo" id="photo" value="<?php echo $adv_info['photo']; ?>"/>
              ...
              <img src="/miniganzhoumaiche/Data/<?php echo $adv_info['photo']; ?>" width="200" height="100" /><br /><br />
              <?php } ?>
