    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li data-index="0">
            ...
            <!-- <iframe class="pro_2" src="/miniganzhoumaiche/Data/inc/photo_add.php?id=photo_sj0&width=200&height=200" frameborder="0"></iframe> -->
              <?php if ($info['logo']) { ?>
                <img src="/miniganzhoumaiche/Data/<?php echo $info['logo']; ?>" width="100" height="100" /><br /><br />
              <?php } ?>
         ...
         <li>
          ...
          <li>
            ...
            <div>
              <input class="inp_1" name="shop_name" id="shop_name" value="<?php echo ($info["shop_name"]); ?>"/>
            </div>
         </li>
          <li>
            <div class="d1">店铺地址:</div>
            <div>
              <input class="inp_1" name="shop_address" id="shop_address" value="<?php echo ($info["shop_address"]); ?>"/>
            </div>
         </li>
          <li>
            <div class="d1">店铺坐标:</div>
            <div>
              <input class="inp_1" name="location" id="location" value="<?php echo ($info["location_x"]); ?>,<?php echo ($info["location_y"]); ?>"/>
              <input type="button" value="选择坐标" class="aaa_pts_web_3" style="margin-left:15px;" onclick="win_open('<?php echo U('Baidumap/index');?>',1280,800)">
            </div>
         </li>
         <li>
