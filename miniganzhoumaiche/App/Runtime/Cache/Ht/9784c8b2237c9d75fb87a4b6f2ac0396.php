    ...
    <div class="aaa_pts_3">
      ...
      <table class="pro_3">
         <tr class="tr_1">
           ...
           <!-- <td>属性</td>
           <td>规格</td> -->
           <td style="width:100px;">首付/万</td>
           <td style="width:80px;">月供</td>
         ...
         <!-- 遍历 -->
          <?php if(is_array($productlist)): $i = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
             <td><?php echo ($v["id"]); ?></td>
             <td style="padding:3px 0;"><img src="/miniganzhoumaiche/Data/<?php echo ($v["photo_x"]); ?>" width="80px" height="80px"/></td>
